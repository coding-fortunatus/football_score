...
@section('breadcrumb')
		...
		<li class="breadcrumb-item breadcrumb-active" aria-current="page">Update</li>
@endsection
@section('content')
						...
						<div class="row">
								<div class="col-sm-12 col-12">
										...
										<div class="card">
												...
												<div class="card-body">
														<!-- Row start -->
														<form action="{{ route('officials.update', $official->official_uuid) }}" method="POST"
																...
																<div class="row">
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="text" class="form-control" id="inputName" value="{{ $official->fullname }}"
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="number" class="form-control" name="phone" id="inputNumber"
																								placeholder="Enter Phone Number" value="{{ $official->phone }}">
																				</div>
																				@error('phone')
																						<small class="text-danger">{{ $message }}</small>
																				@enderror
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="text" class="form-control" name="role" id="inputCompanyName"
																								placeholder="Line Referee, Referee, etc" value="{{ $official->role }}">
																				</div>
																				@error('role')
																						<small class="text-danger">{{ $message }}</small>
																				@enderror
