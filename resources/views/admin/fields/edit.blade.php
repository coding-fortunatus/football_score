								...
								<div class="col-sm-12 col-12">
										...
										<div class="card">
												<div class="card-header">
														<div class="card-title">Update Field</div>
												</div>
												<div class="card-body">
														<!-- Row start -->
														<form action="{{ route('fields.update', $field->field_uuid) }}" method="POST"
																...
																<div class="row">
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="text" class="form-control" id="inputName" value="{{ $field->name }}" name="name"
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="text" class="form-control" name="location" id="inputShort"
																								placeholder="Enter team short name" value="{{ $field->location }}">
																				</div>
																				@error('location')
																						<small class="text-danger">{{ $message }}</small>
																				@enderror
