								...
								<div class="col-sm-12 col-12">
										...
										<div class="card">
												<div class="card-header">
														<div class="card-title">New League</div>
												</div>
												<div class="card-body">
														<!-- Row start -->
																...
																<div class="row">
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="text" class="form-control" id="inputName" value="{{ old('title') }}" name="title"
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="text" class="form-control" name="semester_season" id="inputSeason"
																								placeholder="Enter League Season | Semester" value="{{ old('semester_season') }}">
																				</div>
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="number" class="form-control" name="teams" id="inputTeams"
																								placeholder="Enter Playing Team Capacity" value="{{ old('teams') }}">
																				</div>
																				@error('teams')
																						<small class="text-danger">{{ $message }}</small>
																				@enderror
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<input type="date" class="form-control" name="start_date" id="inputStart"
																								placeholder="12/02/2025" value="{{ old('start_date') }}">
																				</div>
																				@error('start_date')
																						<small class="text-danger">{{ $message }}</small>
																				@enderror
																		...
																		<div class="col-xl-4 col-sm-6 col-12">
																				<div class="mb-3">
																						...
																						<select class="form-select" name="status" id="inputStatus" value="{{ old('status') }}">
																								<option selected>Select League Status</option>
